//
// Created by tipakorng on 9/11/17.
//
...
int main(int argc, char** argv)
{
    ...
    // Initialize ROS node.
    ros::init(argc, argv, "capsule_robot_sim");
    ros::NodeHandle node_handle("active_sensing");

    // Initialize the model.
    CapsuleRobotModel model(argv[1], &node_handle);
    model.publishMap();
    ...
    CapsuleRobotPlanner state_space_planner(argv[1]);
